...
class StockNEntity(Base):
    ...
    start_pri: Mapped[float] = mapped_column(Integer, nullable=False, default=0.0)
    end_pri: Mapped[float] = mapped_column(Integer, nullable=False, default=0.0)
    highest_pri: Mapped[float] = mapped_column(Integer, nullable=False, default=0.0)
    lowest_pri: Mapped[float] = mapped_column(Integer, nullable=False, default=0.0)
