...
class StockPositionEntity(Base):
    ...
    buy_level: Mapped[str] = mapped_column(String(8), nullable=False, default="B1")
    sell_date: Mapped[str] = mapped_column(String(10), nullable=False, default="")
    sell_price: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    sell_amount: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    profit_amount: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    profit_rate: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    profit_status: Mapped[str] = mapped_column(String(16), nullable=False, default="")
    exit_reason: Mapped[str] = mapped_column(String(16), nullable=False, default="")
